  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
		...
		<li style="background-color:	#AFEEEE"><a href="eleve-notes.php"><B>Notes </B></a></li>
...
<center>
<br>
<I><font size="5" color="Blue"> Notes</font></I>
</center>
<br><br>
	...
	<div class="row">
        ...
        <?php
$a=$_SESSION['id'];
$stmt = $db->prepare("select * from notes where id= '$a' and titre='استدعاء ولي' order by id_notes DESC");
     $stmt->execute();
                while($row = $stmt->fetch()){
                  ?>
<ul>
...
?>
        ...
        <?php
$a=$_SESSION['id'];
$stmt = $db->prepare("select * from notes where id= '$a' and titre='طرد' order by id_notes DESC");
     $stmt->execute();
                while($row = $stmt->fetch()){
                  ?>
<ul>
...
?>
        ...
        <?php
$a=$_SESSION['id'];
$stmt = $db->prepare("select * from notes where id= '$a' and titre='انذار' order by id_notes DESC");
     $stmt->execute();
                while($row = $stmt->fetch()){
                  ?>
<ul>
