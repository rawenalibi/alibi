  ...
  <input class="form-control" id="disabledInput"  value="<?php echo $row['niveau'] ?>" disabled="" type="text">
      ...
      <button type="button"   onclick="modifierdata(<?php echo $row['id'] ?>)" class="btn btn-primary">Mise ajour</button>
		...
		<div class="col-md-9 ">
                 ...
                 <img src="img/r.jpg" class="img-rounded" alt="Cinque Terre" width="680" height="150" style="margin-left:30px;"> 
                                    <div class="page-header ">
                                    <h3 style="color:#20B2AA" ><small class="pull-right"></small><span class="glyphicon glyphicon-tags"></span> Résultat </h3>
                                    </div> 


   <div class="notice notice-success">
        <strong>primeir s semester </strong>
        <?php 
    $d=$row['id'];
$stmt1 = $db->prepare("select * from resultat where id_e=$d");
$stmt1->execute();       
while($row1 = $stmt1->fetch() ){
 ...
 ?>
  <div class="notice notice-info">
          <strong><?php echo $row1['date'] ?> </strong>  
      
<a  href="download.php?dow=<?php echo $row1['file'] ?>" >  telecharger  <p class="glyphicon glyphicon-download-alt"></p> </a> 
</div>   
    <?php
