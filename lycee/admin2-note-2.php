        ...
        <li class="dropdown">
         <a class="dropdown-toggle" data-toggle="dropdown" href="#" style="background-color:#CEECF5">note<span class="caret"></span></a>
          <ul class="dropdown-menu">
            ...
            <li style="background-color:#CEECF5"><a href="admin2-note-2.php">2eme anneé</a></li>
...
$tmp_name = $_FILES['myfile']['tmp_name'];
  ...
  header('Location: admin2-note-2.php');
...
?>
   ...
   <div class="form-group mystaff_hide mystaff_lettre" >
  ...
  <div class="form-group mystaff_hide mystaff_science-informatique" >
    <label for="11">Matier</label>
    <select class="form-control" id="mystuff" name="m">
    <option value="m1">m1</option>
    <option value="m2">m2</option>  
  ...
  <div class="form-group mystaff_hide mystaff_science" >
    <label for="11">Matier</label>
    <select class="form-control" id="mystuff" name="m">
    <option value="m1">m1</option>
    <option value="m2">m2</option>  
...
<br>
 ...
 <div class="alert alert-success">
  <strong> letter</strong>
      ...
      <tbody>
      <?php
$stmt = $db->prepare("select  * from note where niveau=2 ");
                $stmt->execute();
...
<table class="table table-bordered table-striped" id="table1">
 <div class="alert alert-success">
  <strong> science-informatique</strong>
</div>
...
$stmt = $db->prepare("select  * from note where niveau=2 ");
                $stmt->execute();
                while($row = $stmt->fetch()){
                    if($row['section'] == "science-informatique")
                    {
                    ?>
