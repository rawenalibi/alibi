  ...
  <input class="form-control" id="disabledInput"  value="<?php echo $row['niveau'] ?>" disabled="" type="text">
      ...
      <button type="button"   onclick="modifierdata(<?php echo $row['id'] ?>)" class="btn btn-primary">Mise ajour</button>
		...
		<div class="col-md-9 ">
                 ...
                 <img src="img/abs.jpg" class="img-rounded" alt="Cinque Terre" width="680" height="150" style="margin-left:30px;"> 
                                    <div class="page-header ">
                                    <h3 style="color:#20B2AA" ><small class="pull-right"></small><span class="glyphicon glyphicon-flag"></span> absences-retard </h3>
                                    </div> 

 <div class="alert alert-info" role="alert">
  <?php
  $s=$row['id'];
        $stmt = $db->prepare("select  * from abs where num_e=$s");
        $stmt->execute();
        $row = $stmt->fetch()
        
          ?>
        <h3><B><font colo='blue'>  <?php echo $row['duree'] ?></font></B></h3>
          <?php
...
<table class="table table-bordered table-striped" id="table1">
      <thead>
        ...
        <?php
     $r=$row['num_e'];
        $stmt = $db->prepare("select  * from abs where num_e='$r'");
        $stmt->execute();
        while($row = $stmt->fetch()){
          if($row['jour']=="lundi" && $row['heure']=='8-9')
          {?><?php echo $row['type'] ?><?php }else{?><?php }}?>
          </th>
          <th>
        <?php
        ...
        $stmt->execute();
        while($row = $stmt->fetch()){
          if($row['jour']=="lundi" && $row['heure']=='9-10')
          {?><?php echo $row['type'] ?><?php }else{?><?php }}?>
          </th>
        ...
        $stmt->execute();
        while($row = $stmt->fetch()){
          if($row['jour']=="lundi" && $row['heure']=='10-11')
          {?><?php echo $row['type'] ?><?php }else{?><?php }}?>
          </th>
        ...
        $stmt->execute();
        while($row = $stmt->fetch()){
          if($row['jour']=="lundi" && $row['heure']=='11-12')
          {?><?php echo $row['type'] ?><?php }else{?><?php }}?>
          </th>
        ...
        $stmt->execute();
        while($row = $stmt->fetch()){
          if($row['jour']=="lundi" && $row['heure']=='14-15')
          {?><?php echo $row['type'] ?><?php }else{?><?php }}?>
          </th>
        ...
        $stmt->execute();
        while($row = $stmt->fetch()){
          if($row['jour']=="lundi" && $row['heure']=='15-16')
          {?><?php echo $row['type'] ?><?php }else{?><?php }}?>
          </th>
        ...
        $stmt->execute();
        while($row = $stmt->fetch()){
          if($row['jour']=="lundi" && $row['heure']=='16-17')
          {?><?php echo $row['type'] ?><?php }else{?><?php }}?>
          </th>
        ...
        $stmt->execute();
        while($row = $stmt->fetch()){
          if($row['jour']=="lundi" && $row['heure']=='17-18')
          {?><?php echo $row['type'] ?><?php }else{?><?php }}?>
          </th>
        </tr>
        ...
        $stmt->execute();
        while($row = $stmt->fetch()){
          if($row['jour']=="mardi" && $row['heure']=='8-9')
          {?><?php echo $row['type'] ?><?php }else{?><?php }}?>
          </th>
          <th>
        <?php
        ...
        $stmt->execute();
        while($row = $stmt->fetch()){
          if($row['jour']=="mardi" && $row['heure']=='9-10')
          {?><?php echo $row['type'] ?><?php }else{?><?php }}?>
          </th>
        ...
        $stmt->execute();
        while($row = $stmt->fetch()){
          if($row['jour']=="mardi" && $row['heure']=='10-11')
          {?><?php echo $row['type'] ?><?php }else{?><?php }}?>
          </th>
        ...
        $stmt->execute();
        while($row = $stmt->fetch()){
          if($row['jour']=="mardi" && $row['heure']=='11-12')
          {?><?php echo $row['type'] ?><?php }else{?><?php }}?>
          </th>
        ...
        $stmt->execute();
        while($row = $stmt->fetch()){
          if($row['jour']=="mardi" && $row['heure']=='14-15')
          {?><?php echo $row['type'] ?><?php }else{?><?php }}?>
          </th>
        ...
        $stmt->execute();
        while($row = $stmt->fetch()){
          if($row['jour']=="mardi" && $row['heure']=='15-16')
          {?><?php echo $row['type'] ?><?php }else{?><?php }}?>
          </th>
        ...
        $stmt->execute();
        while($row = $stmt->fetch()){
          if($row['jour']=="mardi" && $row['heure']=='16-17')
          {?><?php echo $row['type'] ?><?php }else{?><?php }}?>
          </th>
        ...
        $stmt->execute();
        while($row = $stmt->fetch()){
          if($row['jour']=="mardi" && $row['heure']=='17-18')
          {?><?php echo $row['type'] ?><?php }else{?><?php }}?>
          </th>
        </tr>
        ...
        $stmt->execute();
        while($row = $stmt->fetch()){
          if($row['jour']=="mercredi" && $row['heure']=='8-9')
          {?><?php echo $row['type'] ?><?php }else{?><?php }}?>
          </th>
          <th>
        <?php
        ...
        $stmt->execute();
        while($row = $stmt->fetch()){
          if($row['jour']=="mercredi" && $row['heure']=='9-10')
          {?><?php echo $row['type'] ?><?php }else{?><?php }}?>
          </th>
        ...
        $stmt->execute();
        while($row = $stmt->fetch()){
          if($row['jour']=="mercredi" && $row['heure']=='10-11')
          {?><?php echo $row['type'] ?><?php }else{?><?php }}?>
          </th>
        ...
        $stmt->execute();
        while($row = $stmt->fetch()){
          if($row['jour']=="mercredi" && $row['heure']=='11-12')
          {?><?php echo $row['type'] ?><?php }else{?><?php }}?>
          </th>
        ...
        $stmt->execute();
        while($row = $stmt->fetch()){
          if($row['jour']=="mercredi" && $row['heure']=='14-15')
          {?><?php echo $row['type'] ?><?php }else{?><?php }}?>
          </th>
        ...
        $stmt->execute();
        while($row = $stmt->fetch()){
          if($row['jour']=="mercredi" && $row['heure']=='15-16')
          {?><?php echo $row['type'] ?><?php }else{?><?php }}?>
          </th>
        ...
        $stmt->execute();
        while($row = $stmt->fetch()){
          if($row['jour']=="mercredi" && $row['heure']=='16-17')
          {?><?php echo $row['type'] ?><?php }else{?><?php }}?>
          </th>
        ...
        $stmt->execute();
        while($row = $stmt->fetch()){
          if($row['jour']=="mercredi" && $row['heure']=='17-18')
          {?><?php echo $row['type'] ?><?php }else{?><?php }}?>
          </th>
        </tr>
        ...
        $stmt->execute();
        while($row = $stmt->fetch()){
          if($row['jour']=="jeudi" && $row['heure']=='8-9')
          {?><?php echo $row['type'] ?><?php }else{?><?php }}?>
          </th>
          <th>
        <?php
        ...
        $stmt->execute();
        while($row = $stmt->fetch()){
          if($row['jour']=="jeudi" && $row['heure']=='9-10')
          {?><?php echo $row['type'] ?><?php }else{?><?php }}?>
          </th>
        ...
        $stmt->execute();
        while($row = $stmt->fetch()){
          if($row['jour']=="jeudi" && $row['heure']=='10-11')
          {?><?php echo $row['type'] ?><?php }else{?><?php }}?>
          </th>
        ...
        $stmt->execute();
        while($row = $stmt->fetch()){
          if($row['jour']=="jeudi" && $row['heure']=='11-12')
          {?><?php echo $row['type'] ?><?php }else{?><?php }}?>
          </th>
        ...
        $stmt->execute();
        while($row = $stmt->fetch()){
          if($row['jour']=="jeudi" && $row['heure']=='14-15')
          {?><?php echo $row['type'] ?><?php }else{?><?php }}?>
          </th>
        ...
        $stmt->execute();
        while($row = $stmt->fetch()){
          if($row['jour']=="jeudi" && $row['heure']=='15-16')
          {?><?php echo $row['type'] ?><?php }else{?><?php }}?>
          </th>
        ...
        $stmt->execute();
        while($row = $stmt->fetch()){
          if($row['jour']=="jeudi" && $row['heure']=='16-17')
          {?><?php echo $row['type'] ?><?php }else{?><?php }}?>
          </th>
        ...
        $stmt->execute();
        while($row = $stmt->fetch()){
          if($row['jour']=="jeudi" && $row['heure']=='17-18')
          {?><?php echo $row['type'] ?><?php }else{?><?php }}?>
          </th>
        </tr>
        ...
        $stmt->execute();
        while($row = $stmt->fetch()){
          if($row['jour']=="vendredi" && $row['heure']=='8-9')
          {?><?php echo $row['type'] ?><?php }else{?><?php }}?>
          </th>
          <th>
        <?php
        ...
        $stmt->execute();
        while($row = $stmt->fetch()){
          if($row['jour']=="vendredi" && $row['heure']=='9-10')
          {?><?php echo $row['type'] ?><?php }else{?><?php }}?>
          </th>
        ...
        $stmt->execute();
        while($row = $stmt->fetch()){
          if($row['jour']=="vendredi" && $row['heure']=='10-11')
          {?><?php echo $row['type'] ?><?php }else{?><?php }}?>
          </th>
        ...
        $stmt->execute();
        while($row = $stmt->fetch()){
          if($row['jour']=="vendredi" && $row['heure']=='11-12')
          {?><?php echo $row['type'] ?><?php }else{?><?php }}?>
          </th>
        ...
        $stmt->execute();
        while($row = $stmt->fetch()){
          if($row['jour']=="vendredi" && $row['heure']=='14-15')
          {?><?php echo $row['type'] ?><?php }else{?>--<?php }}?>
          </th>
        ...
        $stmt->execute();
        while($row = $stmt->fetch()){
          if($row['jour']=="vendredi" && $row['heure']=='15-16')
          {?><?php echo $row['type'] ?><?php }else{?>--<?php }}?>
          </th>
        ...
        $stmt->execute();
        while($row = $stmt->fetch()){
          if($row['jour']=="vendredi" && $row['heure']=='16-17')
          {?><?php echo $row['type'] ?><?php }else{?>--<?php }}?>
          </th>
        ...
        $stmt->execute();
        while($row = $stmt->fetch()){
          if($row['jour']=="vendredi" && $row['heure']=='17-18')
          {?><?php echo $row['type'] ?><?php }else{?>--<?php }}?>
          </th>
        </tr>
        ...
        $stmt->execute();
        while($row = $stmt->fetch()){
          if($row['jour']=="samedi" && $row['heure']=='8-9')
          {?><?php echo $row['type'] ?><?php }else{?><?php }}?>
          </th>
          <th>
        <?php
        ...
        $stmt->execute();
        while($row = $stmt->fetch()){
          if($row['jour']=="samedi" && $row['heure']=='9-10')
          {?><?php echo $row['type'] ?><?php }else{?><?php }}?>
          </th>
        ...
        $stmt->execute();
        while($row = $stmt->fetch()){
          if($row['jour']=="samedi" && $row['heure']=='10-11')
          {?><?php echo $row['type'] ?><?php }else{?><?php }}?>
          </th>
        ...
        $stmt->execute();
        while($row = $stmt->fetch()){
          if($row['jour']=="samedi" && $row['heure']=='11-12')
          {?><?php echo $row['type'] ?><?php }else{?><?php }}?>
          </th>
        ...
        $stmt->execute();
        while($row = $stmt->fetch()){
          if($row['jour']=="samedi" && $row['heure']=='14-15')
          {?><?php echo $row['type'] ?><?php }else{?>--<?php }}?>
          </th>
        ...
        $stmt->execute();
        while($row = $stmt->fetch()){
          if($row['jour']=="samedi" && $row['heure']=='15-16')
          {?><?php echo $row['type'] ?><?php }else{?>--<?php }}?>
          </th>
        ...
        $stmt->execute();
        while($row = $stmt->fetch()){
          if($row['jour']=="samedi" && $row['heure']=='16-17')
          {?><?php echo $row['type'] ?><?php }else{?>--<?php }}?>
          </th>
        ...
        $stmt->execute();
        while($row = $stmt->fetch()){
          if($row['jour']=="samedi" && $row['heure']=='17-18')
          {?><?php echo $row['type'] ?><?php }else{?>--<?php }}?>
          </th>
        </tr>
