...
<B  style="color:#5a7391;"><font size="5" >maknssy</font></B></a>
</td>
<td > 
      ...
      <button type="button"   onclick="modifierdata(<?php echo $row['id'] ?>)" class="btn btn-primary">Mise ajour</button>
		...
		<div class="col-md-9 ">
                 <div class="profile-content vl">
                                    <img src="img/pro.jpg" class="img-rounded" alt="Cinque Terre" width="680" height="150" style="margin-left:30px;"> 
                                          <div class="page-header ">
                                            <h3 style="color:#20B2AA" ><small class="pull-right"></small><span class="glyphicon glyphicon-user"></span> Liste Professeurs</h3>
                                          </div>      
     <?php
$a=$_SESSION['name'];
...
$stmt->execute();
                while($row = $stmt->fetch()){
                    ?>
<div class="row ">
        <div class="col-xs-12 col-sm-offset-3 col-sm-6 ta">
            <div class="panel panel-default ta">
                  
                <ul class="list-group" id="contact-list">
                    <li class="list-group-item ">
                        <div class="col-xs-12 col-sm-3" >
                            <td > <?php echo '<img src="data:img/jpg;base64,'.base64_encode( $row['img'] ).'" style="border-radius: 50% ;" width="80" height="80"/>' ?></td>

                        </div>
                        <div class="col-xs-12 col-sm-6 ">
                    
                            <span class="name"><font size="5"><?php echo $row['nom'] ?></font></span><br/>
                            <br>
                            <span style="color:#A9D0F5;"   class="glyphicon glyphicon-envelope" data-toggle="tooltip" title="<?php echo $row['email'] ?>"></span>
                            <span class="visible-xs"> <span class="text-muted">5842 Hillcrest Rd</span><br/></span>

                            <span style="margin-left:30px; color:#A9D0F5;"  class="glyphicon glyphicon-earphone"  data-toggle="tooltip" title="<?php echo $row['num_tel'] ?>"></span>
                            <span  class="visible-xs"> <span  class="text-muted">(870) 288-4149</span><br/></span>
                            
                            <span  style="margin-left:30px; color:#A9D0F5;" class="glyphicon glyphicon-briefcase" data-toggle="tooltip" title="<?php echo $row['spe'] ?>"></span>
                            <span class="visible-xs"> <span class="text-muted">(870) 288-4149</span><br/></span>
