  ...
  <input class="form-control" id="disabledInput"  value="<?php echo $row['niveau'] ?>" disabled="" type="text">
      ...
      <button type="button"   onclick="modifierdata(<?php echo $row['id'] ?>)" class="btn btn-primary">Mise ajour</button>
		...
		<div class="col-md-9 ">
                 ...
                 <img src="img/bib4.jpg" class="img-rounded" alt="Cinque Terre" width="680" height="150" style="margin-left:30px;"> 
                                    <div class="page-header ">
                                    <h3 style="color:#20B2AA" ><small class="pull-right"></small><span class="glyphicon glyphicon-ok"></span> Bibliothèque</h3>
                                    </div> 
                                    <br />
...
<br />
    <table class="table table-bordered table-striped" width="100%" id="table1">
        <thead>
            <tr>
                <th>Nom Du livre</th>
                <th>Source</th>
...
$stmt = $db->prepare("select * from livre");
            ...
            <tr align="center">
                ...
                {
                ?>
                <td> <a  href="download.php?dow=<?php echo $row['path'] ?>" > Télécharger  <p class="glyphicon glyphicon-download-alt"></p></a></td>
                <?php
                }
                else
                { 
                    ?>
                    <td> pas de fichier à télécharger</td>
                    <?php
                }
            ?>
...
$e=  $row['id'] ;
$stmt1 = $db->prepare("select * from livre where id='$e'");
