...
<div class="form-group">
  ...
  <input class="form-control" id="disabledInput"  value="<?php echo $row['niveau'] ?>" disabled="" type="text">
		...
		<div class="col-md-9 ">
                 ...
                 <img src="img/2.jpg" class="img-rounded" alt="Cinque Terre" width="680" height="150" style="margin-left:30px;"> 
                   <div class="page-header ">
                    <h3 style="color:#20B2AA" ><small class="pull-right"></small><span class="glyphicon glyphicon-globe"></span>Attestation de présence
                         </h3>
                  </div>                  
    ...
    <div class="notice notice-success">
        ...
        <strong> 
        <button  onclick="insertat(<?php echo $row['id'] ?>)" class="btn btn-primary">Enregistrer</button>
        </strong>  <span class="pull-right text-success readMore"></span>
        <div >
           <p>
           <br>
           <?php
