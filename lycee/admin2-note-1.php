        ...
        <li class="dropdown">
         <a class="dropdown-toggle" data-toggle="dropdown" href="#" style="background-color:#CEECF5">note<span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li style="background-color:#CEECF5"><a href="admin2-note-1.php">1ere anne</a></li>
...
$tmp_name = $_FILES['myfile']['tmp_name'];
  ...
  header('Location: admin2-note-1.php');
...
<br>
 ...
 <div class="alert alert-success">
  <strong> section 1</strong>
      ...
      <tbody>
      <?php
$stmt = $db->prepare("select  * from note where niveau=1 ");
                $stmt->execute();
